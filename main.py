...
class HomeScreen(Screen):
    def __init__(self, **kwargs):
        ...
        home_icon = MDFloatingActionButton(
            ...
            size=(dp(100), dp(100)),  # Use dp for size
    ...
    def update_location_list(self):
        ...
        try:
            ...
            if locations:
                ...
                no_location_label = MDLabel(text="No Locations Found", font_size=sp(30), theme_text_color="Custom",halign="center",text_color=(1, 1, 1, 1))
        ...
        try:
            ...
            if service_ids:  # Check if service_ids list is not empty
                ...
                for service_booking in service_provider_view_requests:
                    ...
                    number_of_sq_feet_provider = MDLabel(text=str(number_of_sq_feet), font_size=sp(15),
                                                         text_color=(0, 0, 0.5, 1), theme_text_color="Custom")
                    description_provider = MDLabel(text=str(description), font_size=sp(15), text_color=(0, 0, 0.5, 1),
                                                   theme_text_color="Custom")
                    booking_date_provider = MDLabel(text=str(booking_date), font_size=sp(15), text_color=(0, 0, 0.5, 1),
                                                    theme_text_color="Custom")
                    ...
                    service_name_provider_label = MDLabel(text=service_name_provider, font_size=sp(15),
                                                          text_color=(0, 0, 0.5, 1), theme_text_color="Custom")
                    charger_per_sq_feet_provider = MDLabel(text=f"${charger_per_sq_feet}", font_size=sp(15),
                                                           text_color=(0, 0, 0.5, 1), theme_text_color="Custom")
                    ...
                    if service_booking[7] in ["Accepted Request", "Paid Advance Amount", "Service Completed"]:
                        service_booking_date = MDLabel(
                            ...
                            font_style="Caption",
                            font_size=sp(20),  # Set the font size to 20 density-independent pixels (dp)
                            size_hint_y=None,
                            height=dp(30),
                            bold=True
                        )
        ...
        try:
            ...
            if service_ids:  # Check if service_ids list is not empty
                ...
                for service_booking in view_histories:
                    ...
                    number_of_sq_feet_history = MDLabel(text=str(number_of_sq_feet), font_size=sp(17),
                                                        text_color=(0, 0, 0.5, 1), theme_text_color="Custom")
                    service_description_full_history = MDLabel(text=str(description), font_size=sp(17),
                                                               text_color=(0, 0, 0.5, 1), theme_text_color="Custom")
                    service_booking_date_full_history = MDLabel(text=str(booking_date), font_size=sp(17),
                                                                text_color=(0, 0, 0.5, 1), theme_text_color="Custom")
                    service_history = MDLabel(text=service_full_name_history, font_size=sp(17), text_color=(0, 0, 0.5, 1),
                                              theme_text_color="Custom")
                    charger_history = MDLabel(text=f"${charger_per_sq_feet}", font_size=sp(17), text_color=(0, 0, 0.5, 1),
                                              theme_text_color="Custom")
